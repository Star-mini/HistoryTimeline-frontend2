...
const HistoryLabel = ({direction, data, isHidden}) => {
    ...
    const checkVisibility = () => {
        if (componentRef.current) {
          ...
          const isVisible = componentCenterY < window.scrollY + viewportCenterY;
